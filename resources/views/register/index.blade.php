                ...
                <form class="d-grid gap-2" action="/register" method="post">
                    ...
                    <div class="form-floating">
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                            id="name" placeholder="name" autocomplete="off" required value="{{ old('name') }}">
                    ...
                    <div class="form-floating">
                        <input type="text" name="username" class="form-control @error('username') is-invalid @enderror"
                            id="username" placeholder="username" autocomplete="off" required value="{{ old('username') }}">
                    ...
                    <div class="form-floating">
                        <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                            id="email" placeholder="name@example.com" autocomplete="off" required
                            value="{{ old('email') }}">
